...
local spr_chara_left_allperfect = 0
local spr_chara_right_allperfect = 0
local spr_chara_left_allperfect_flash = 0
local spr_chara_right_allperfect_flash = 0
local spr_chara_left_allperfect_in = 0
local spr_chara_right_allperfect_in = 0
...
local text_fullcombo_offset_x = 204
...
function loadAssets()
    ...
    spr_chara_left_allperfect = func:AddSprite('../Chara_Left_AllPerfect.png')
    spr_chara_right_allperfect = func:AddSprite('../Chara_Right_AllPerfect.png')
    spr_chara_left_allperfect_flash = func:AddSprite('../Chara_Left_AllPerfect_Flash.png')
    spr_chara_right_allperfect_flash = func:AddSprite('../Chara_Right_AllPerfect_Flash.png')
    spr_chara_left_allperfect_in = func:AddSprite('../Chara_Left_AllPerfect_In.png')
    spr_chara_right_allperfect_in = func:AddSprite('../Chara_Right_AllPerfect_In.png')
    for i = 1, 5 do
    ...
    spr_text_fullcombo = func:AddSprite('../Text_AllPerfect.png')
    spr_text_fullcombo_flash = func:AddSprite('../Text_AllPerfect_Flash.png')
    spr_text_fullcombo_back = func:AddSprite('../Text_AllPerfect_Back.png')
    for i = 1, 6 do
    ...
    spr_AllPerfect_BG = func:AddSprite('../AllPerfect_BG.png')
    ...
    for player = 1, playerCount do
        if playing[player] then
            ...
            if text_clear_counter[player] > 2.5 then
                ...
                func:DrawSpriteOpacity(x[player], y[player], math.min(text_flash_basevalue * 4, 1), spr_AllPerfect_BG)
            ...
            elseif charaAnimeState[player] == "FullCombo_Move" then
                ...
                change_value = math.min(math.max((move_value - 0.5) * 4.0, 0), 1)
                if change_value < 0.5 then
                    in_opacity = change_value * 2
                    func:DrawSpriteOriginScaleAlpha(left_x - move_x, left_y - move_y, 1, 1, 1, "Left_Up", spr_chara_left_clear_in[8])
                    func:DrawSpriteOriginScaleAlpha(left_x - move_x, left_y - move_y, 1, 1, in_opacity, "Left_Up", spr_chara_left_allperfect_in)
                    func:DrawSpriteOriginScaleAlpha(right_x + move_x, right_y - move_y, 1, 1, 1, "Right_Up", spr_chara_right_clear_in[8])
                    func:DrawSpriteOriginScaleAlpha(right_x + move_x, right_y - move_y, 1, 1, in_opacity, "Right_Up", spr_chara_right_allperfect_in)
                else
                    flash_opacity = 2 - (change_value * 2)
                    func:DrawSpriteOriginScaleAlpha(left_x - move_x, left_y - move_y, 1, 1, 1, "Left_Up", spr_chara_left_allperfect)
                    func:DrawSpriteOriginScaleAlpha(left_x - move_x, left_y - move_y, 1, 1, flash_opacity, "Left_Up", spr_chara_left_allperfect_flash)
                    func:DrawSpriteOriginScaleAlpha(right_x + move_x, right_y - move_y, 1, 1, 1, "Right_Up", spr_chara_right_allperfect)
                    func:DrawSpriteOriginScaleAlpha(right_x + move_x, right_y - move_y, 1, 1, flash_opacity, "Right_Up", spr_chara_right_allperfect_flash)
                end
            ...
            elseif charaAnimeState[player] == "FullCombo_Out" then
                ...
                scale_y = 1.0 - scale_value
                move_y = (scale_value * 380)
                func:DrawSpriteOriginScaleAlpha(left_x - move_x, left_y + move_y, 1, scale_y, 1, "Left_Up", spr_chara_left_allperfect)
                func:DrawSpriteOriginScaleAlpha(right_x + move_x, right_y + move_y, 1, scale_y, 1, "Right_Up", spr_chara_right_allperfect)
            elseif charaAnimeState[player] == "FullCombo_Idle" then
                move_x = chara_clear_move_x + chara_fullcombo_move_x
                func:DrawSpriteOriginScaleAlpha(left_x - move_x, left_y, 1, 1, 1, "Left_Up", spr_chara_left_allperfect)
                func:DrawSpriteOriginScaleAlpha(right_x + move_x, right_y, 1, 1, 1, "Right_Up", spr_chara_right_allperfect)
